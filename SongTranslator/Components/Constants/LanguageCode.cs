...
namespace SongTranslator.Components.Constants
{
    ...
    public static LanguageCode FromString(string str)
    {
        ...
        {
            throw new ArgumentException($"{nameof(LanguageCode)} must be one of the followings https://github.com/sigaloid/LibreTranslate.Net#language-codes");
        }
    }
